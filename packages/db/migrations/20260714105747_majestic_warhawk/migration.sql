...
ALTER TABLE "inventory_movement" ADD CONSTRAINT "inventory_movement_component_organization_fkey" FOREIGN KEY ("component_id","organization_id") REFERENCES "component"("id","organization_id") ON DELETE RESTRICT;
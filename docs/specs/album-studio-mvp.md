...
- A Product owns ordered Option Groups. Group input types are `single`, `boolean`, or `number`. Single and boolean groups own Option Values with per-unit fixed price adjustments, including zero.
